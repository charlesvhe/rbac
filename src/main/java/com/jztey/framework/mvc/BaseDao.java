...
public abstract class BaseDao<T extends BaseEntity> {
    ...
    public List<T> findByExample(int fistResult, int maxResult, Map<String, Object> propertyValueMap) {
        ...
        return em.createQuery(
                buildWhere(cb, cq, root, propertyValueMap)
    ...
    private <Q> CriteriaQuery<Q> buildWhere(CriteriaBuilder cb, CriteriaQuery<Q> cq, Root<T> root, Map<String, Object> propertyValueMap) {
